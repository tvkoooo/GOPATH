...
func (a *AppConfig) LoadConfig() {
	...
	if err != nil {
		logfile.SystemLogPrintln("ERROR", "LoadConfig::Loading configuration file config.yaml failed", err.Error())
	}
